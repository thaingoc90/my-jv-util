 ...
 * "http://java.sun.com/j2se/1.5/docs/guide/security/CryptoSpec.html#AppA" >Message Digest
 * Algorithms</a>
 * </p>
 * 
...
public class MessageDigestPasswordEncoder extends BasePasswordEncoder {
	 ...
	 * 
	 * @param algorithm
	 *            String The digest algorithm to use. Supports the named <a href=
	 *            "http://java.sun.com/j2se/1.5/docs/guide/security/CryptoSpec.html#AppA" >Message
	...
	/**
	 * {@inheritDoc} Normally digest password encoder is a one-way hash, which does not support
	 * decoding of the encoded password.
	 */
